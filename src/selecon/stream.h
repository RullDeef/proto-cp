...
sstream_id_t scont_alloc_video_stream(struct SStreamContainer *cont,
  enum SStreamDirection dir, size_t width, size_t height);
...
enum SError scont_push_frame(struct SStreamContainer *cont, sstream_id_t stream, struct AVFrame* frame);
